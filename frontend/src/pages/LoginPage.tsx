      ...
      <div className="flex min-h-screen items-center justify-center bg-gray-50">
        <div className="w-full max-w-sm rounded-lg border border-gray-200 bg-white p-8 shadow-sm">
          <h1 className="mb-2 flex items-center gap-2 text-xl font-bold text-gray-900">
            <KeyRound size={20} /> Set Your Password
          </h1>
          ...
          <form onSubmit={handleChangePassword} className="space-y-4">
            ...
            <button
              type="submit"
              className="btn-raised w-full rounded bg-[#28324f] py-2 text-sm font-semibold text-white hover:bg-[#1c2439]"
            >
              Set Password
            </button>
          </form>
      ...
      <div className="w-full max-w-sm rounded-lg border border-gray-200 bg-white p-8 shadow-sm">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={submitting}
            className="btn-raised w-full rounded bg-[#28324f] py-2 text-sm font-semibold text-white hover:bg-[#1c2439] disabled:opacity-50"
          >
